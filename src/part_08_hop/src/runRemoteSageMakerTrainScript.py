...
import numpy as np
import argparse, os, json, codecs, logging
...
def main(args):
    ...
    logger.info(f'Files in the training folder-----: {os.listdir( train_dir )}')
    logger.info(f'Files in the testing folder------: {os.listdir( test_dir )}')
    ...
    logger.info('Validation loss: ', score[0])
    logger.info('Validation accuracy: ', score[1])
